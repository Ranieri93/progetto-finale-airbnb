        ...
        <div class="col-6 offset-3">
            ...
            <form name="Form" onsubmit="return validateForm()" method="post" id="create-form-apartment" action="{{route('admin.apartments.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="room_number" id="room_number" placeholder="Scrivi qui il numero delle stanze" value="{{old('room_number')}}">
                </div>
                <div class="form-group">
                    <label for="guest_number">Numero Ospiti</label>
                    <input type="text" class="form-control" name="guest_number" id="guest_number" placeholder="Scrivi qui il numero degli ospiti" value="{{old('guest_number')}}">
                </div>
                <div class="form-group">
                    <label for="wc_number">Numero Bagni</label>
                    <input type="text" class="form-control" name="wc_number" id="wc_number" placeholder="Scrivi qui il numero dei bagni" value="{{old('wc_number')}}">
                </div>
                <div class="form-group">
                    <label for="square_meters">Metri Quadrati</label>
                    <input type="text" class="form-control" name="square_meters" id="square_meters" placeholder="Scrivi qui la metratura" value="{{old('square_meters')}}">
                </div>
